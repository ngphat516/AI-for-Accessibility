...
const DEFAULT_FOCUS = { section: 'center' as const, index: 0 };
const ChatView: React.FC<ChatViewProps> = ({ isSidebarOpen = false, notes = [], onSaveNote = () => {}, onDeleteNote = () => {}, focus = DEFAULT_FOCUS, setFocus = () => {}, isModalOpen }) => {
